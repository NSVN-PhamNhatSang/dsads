class NtsSortableBindingHandler implements KnockoutBindingHandler {
    ...
    addMetaDataAfterRender = (elements, data) => {
        let self = this;
    ...
    updateIndexFromDestroyedItems = (index, items) => {
        let self = this,
    ...
    stripTemplateWhitespace = (element, name) => {
        let self = this,
            templateSource,
            templateElement;
    ...
    prepareTemplateOptions = (valueAccessor, dataName) => {
        let self = this,
            result: any = {},

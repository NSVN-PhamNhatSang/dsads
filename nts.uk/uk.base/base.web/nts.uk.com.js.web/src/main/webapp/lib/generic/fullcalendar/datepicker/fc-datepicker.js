...
(function (factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define('fc-datepicker', ['jquery'], factory);
...
// ↑MOD
    ...
    createItem: function (data) {
      ...
      var classes = data.class !=''? [data.class]: [];
    ...
    fillWeek: function () {
      ...
      for (i = 0; i <= 6; i++) {
        list += this.createItem({
          text: days[i],
          class: days[i] == options.daysMin[6] ? 'sat' : days[i] == options.daysMin[0]  ? 'sun' : ''
        });
      }
    ...
    fillDays: function () {
      ...
      for (i = length - (n - 1); i <= length; i++) {
        ...
        prevItems.push(this.createItem({
          ...
          class: moment(date).day() == 6 ? 'sat' : moment(date).day() == 0 ? 'sun' : '' 
        }));
      }
  ...
  Datepicker.DEFAULTS = {
    ...
    template: (
      '<div class="fc-datepicker-container">' +
        '<div class="fc-datepicker-panel" data-view="years picker">' +
          '<ul>' +
        ...
        '</div>' +
        '<div class="fc-datepicker-panel" data-view="months picker">' +
          '<ul>' +
        ...
        '</div>' +
        '<div class="fc-datepicker-panel" data-view="days picker">' +
          '<ul>' +
  ...
  $.fn.fcdatepicker = function (option) {
  ...
  $.fn.fcdatepicker.Constructor = Datepicker;
  $.fn.fcdatepicker.languages = Datepicker.LANGUAGES;
  $.fn.fcdatepicker.setDefaults = Datepicker.setDefaults;

  // No conflict
  $.fn.fcdatepicker.noConflict = function () {

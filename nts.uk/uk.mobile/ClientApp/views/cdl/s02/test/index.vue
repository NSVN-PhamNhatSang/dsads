<template>
<div class="cdls02test">
    <h3>{{title | i18n}}</h3>
    <nts-checkbox v-model="data.isDisplayClosureSelection" v-bind:value="1">Display Closure Selection</nts-checkbox>
    ...
    <nts-text-editor v-model="selectedName" :disabled="true" name='selected name'/>

...
<div class="documentscontrolsradio">
    ...
    <div class="form-group row">
        <!--title-->
        <div class="col-md-4">
            <v-label>{{ 'Radio with foreach' | i18n }}</v-label>
        </div>
        <!--radio-->
        <div class="col-md-8">

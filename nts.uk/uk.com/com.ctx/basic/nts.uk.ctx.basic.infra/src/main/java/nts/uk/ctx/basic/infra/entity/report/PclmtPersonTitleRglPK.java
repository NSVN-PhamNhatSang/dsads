...
/**
 * The Class PclmtPersonTitleRglPK.
 */
@Setter
@Getter
@Embeddable
public class PclmtPersonTitleRglPK implements Serializable {
	...
	public boolean equals(Object object) {
		if (!(object instanceof PclmtPersonTitleRglPK)) {
			return false;
		}
		PclmtPersonTitleRglPK other = (PclmtPersonTitleRglPK) object;
	...
	public String toString() {
		return "entity.PclmtPersonTitleRglPK[ ccd=" + ccd + ", pid=" + pid + ", histId=" + histId + " ]";
	}
